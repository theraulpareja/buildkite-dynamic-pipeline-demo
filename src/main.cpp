...
int main() {
    std::cout << "[Fiction Factory Engine] Doing some heavy computations that usually takes a long time here ..." << std::endl;
    ...
    std::cout << "[Fiction Factory Engine] Game Paused!" << std::endl;
